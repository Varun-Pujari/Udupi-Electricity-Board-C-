<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="BillStatus.aspx.cs" Inherits="UEB2.BillStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="1400px" Font-Size="Larger" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Center">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UEB1ConnectionString %>" SelectCommand="SELECT [Name], [Bill_No], [Customer_No], [RR_No], [Amount], [Penalty] FROM [tblBill] WHERE ([Paid] = 'Yes') ">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:UEB1ConnectionString %>" SelectCommand="SELECT [Name], [Bill_No], [Customer_No], [RR_No], [Amount], [Penalty] FROM [tblBill] WHERE ([Paid] = 'No')">
            <SelectParameters>
                <asp:Parameter DefaultValue="Yes" Name="Bill" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
