<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerMaster.Master" AutoEventWireup="true" CodeBehind="CustFeedback.aspx.cs" Inherits="UEB2.CustFeedback" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <title>UEB-CustomerFeedback</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="title-heading-w3 text-center mx-auto">
        <h3 class="title-big">Give Us Your Valuable Feedback </h3>
    </div>
...
width: 700px; border-radius: 8px; padding: 20px;">
        ...
        <InsertItemTemplate>
            <span style="">Date:
            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Date") %>' />
            <br />Name:
            <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("Name") %>' />
            <br />Feedback:
            <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("Feedback") %>' />
            <br />
...
width: 700px; border-radius: 8px; padding: 20px;">
            ...
            <br />
            <span class="labell">Feedback:</span>
            <asp:Label ID="Label3" runat="server" Text='<%# Eval("Feedback") %>' />
            <br />
        ...
        <SelectedItemTemplate>
            ...
            <br />
            Feedback:
            <asp:Label ID="Label6" runat="server" Text='<%# Eval("Feedback") %>' />
            <br />
<br /></span>
        </SelectedItemTemplate>
    </asp:ListView>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:UEB1ConnectionString %>" SelectCommand="SELECT [Date], [Name], [Feedback] FROM [tblFeedback]"></asp:SqlDataSource>
        ...
        <input type="text" id="Name" class="Name" runat="server" placeholder="Your Name" required="required" readonly/>
